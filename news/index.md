...
- Fix
  ...
  if `sampleData` has row names, they have to match the names of the
  data files.
...
- Add support to read/write sample data from/to a *MsBackendSql*
  database
  ([issue](https://github.com/rformassspectrometry/MsExperiment/issues/39)
  [\#39](https://github.com/RforMassSpectrometry/MsExperiment/issues/39)).

### MsExperiment 1.5.1

- Fix subset with negative indices
  ([issue](https://github.com/rformassspectrometry/MsExperiment/issues/37)
  [\#37](https://github.com/RforMassSpectrometry/MsExperiment/issues/37).)
...
- Add `readMsExperiment` function
  ([issue](https://github.com/rformassspectrometry/MsExperiment/issues/32)
  [\#32](https://github.com/RforMassSpectrometry/MsExperiment/issues/32)).

### MsExperiment 1.1.1

- Use
  [`S4Vectors::findMatches`](https://rdrr.io/pkg/S4Vectors/man/Vector-comparison.html)
  in `linkSampleData` which improves performance, especially for larger
  data sets.
...
- Fix imports.
- Inherit from the
  [`S4Vectors::Annotated`](https://rdrr.io/pkg/S4Vectors/man/Annotated-class.html)
  class.
