...
mse@qfeatures$sample

mse <- linkSampleData(mse, with = "sampleData.sample_id = qfeatures.sample")
mse
```
...
`qfeatures` will thus return only the quantified feature abundances for this
second sample.
